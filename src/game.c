...
void HandleInput(GameState *game)
{
    ...
    else
    {
        ...
        currentLeft = IsKeyDown(KEY_A);
        currentRight = IsKeyDown(KEY_D);
        currentUp = IsKeyDown(KEY_W);
        currentDown = IsKeyDown(KEY_S);
        currentA = IsKeyDown(KEY_APOSTROPHE); // A button typically mapped to Z
        currentB = IsKeyDown(KEY_SLASH);      // B button typically mapped to X
    }
